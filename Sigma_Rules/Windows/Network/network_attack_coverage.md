# Windows Network Attack Detection Coverage

This document summarizes all network-based attack types covered by Sigma rules in this project and explains their contribution to comprehensive Windows security monitoring.
...
14. **SMB/Windows File Sharing Abuse**
    - Detects unusual SMB connections from Windows hosts.
...
This approach significantly enhances the security posture of Windows systems by leveraging network logs and Sigma rules for automated, scalable, and actionable threat detection.
